...
<body style="background-image: url('/assets/img/bgc.svg')" >
  <div id="app">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="../assets/img/pngegg.png" alt="logo" width="100" >
            </div>
              ...
              <div class="card-body">
                <form method="POST" action={{ route('login') }} class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="text" class="form-control @error('password')is-invalid @enderror" name="password" tabindex="2" required>
                    <div class="invalid-feedback">
